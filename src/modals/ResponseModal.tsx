...
import { AxiosLockResponseModal } from './ConfirmLockModal';
interface props{
  setShowModal: Function
  response: AxiosResponseModal | AxiosLockResponseModal
            ...
            <div className="border rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                <button
                  ...
                  type="button"
                  onClick={() => {props.setShowModal(false); props.setShowAddModal(false);if(props.response.status === 200 || props.response.status === 201)
